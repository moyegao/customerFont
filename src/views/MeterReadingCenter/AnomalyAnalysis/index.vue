  ...
  <div class="AnomalyAnalysis">
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        <el-table-column type="index" label="NO." width="50" :index="indexMethod" fixed></el-table-column>
        <el-table-column prop="meterAddress" min-width="70" label="册本号"></el-table-column>
        ...
        <el-table-column prop="meterAddress" min-width="80" label="增减水量"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="分摊水量"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="实际用水量"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="上期用水"></el-table-column>
        <el-table-column prop="position7" min-width="80" label="六期平均"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.common.changeTable(this, ".AnomalyAnalysis .kl-table", [
