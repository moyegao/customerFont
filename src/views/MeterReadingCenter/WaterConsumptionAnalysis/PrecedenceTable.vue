  ...
  <div class="PrecedenceTable">
      ...
      <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
        <el-form-item class="form-left">
          ...
          <el-form-item label="账期：" class="width-150">
            <el-date-picker v-model="formData.beginYearM" size="mini" type="month" unlink-panels format="yyyyMM" value-format="yyyyMM" placeholder="选择月" style="width:48% !important;">
            </el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="册本号：">
            <el-input v-model="formData.book" placeholder="请输入册本号"></el-input>
          </el-form-item>
          
          <el-form-item label="用水类型：">
            <el-select v-model="formData.priceClassification" size="mini">
              <el-option label="全部" value="0"></el-option>
              <el-option label="居民用水" value="1"></el-option>
              <el-option label="非居民用水" value="2"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item v-show="isActive" class="advancedQuery">
            <el-form-item label="营业所：">
              <el-select v-model="formData.businessArea" size="mini">
                <el-option label="城区" value="0"></el-option>
            ...
            <el-form-item label="抄表日期：">
              <el-date-picker v-model="formData.meterReadingDate" type="date" placeholder="选择日期">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="水表口径：">
              ...
              <el-select v-model="formData.caliberItem" size="mini">
                <el-option label="全部" value="0"></el-option>
                <el-option label="DN15" value="1"></el-option>
                <el-option label="DN20" value="2"></el-option>
                <el-option label="DN25" value="3"></el-option>
                <el-option label="DN40" value="4"></el-option>
                <el-option label="DN50" value="5"></el-option>
                <el-option label="DN80" value="6"></el-option>
                <el-option label="DN100" value="7"></el-option>
                <el-option label="DN150" value="8"></el-option>
                <el-option label="DN200" value="9"></el-option>
                <el-option label="DN300" value="10"></el-option>
              </el-select>
            </el-form-item>
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="userNum" min-width="80" label="册本号"></el-table-column>
        <el-table-column prop="userAddress" min-width="80" label="用户编号"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="用户名称"></el-table-column>
        ...
        <el-table-column prop="meterAddress" min-width="80" label="环比增减"></el-table-column>
        <el-table-column prop="meterAddress" min-width="100" label="环比增减率"></el-table-column>
        <el-table-column prop="meterAddress" min-width="120" label="去年同期水量"></el-table-column>
        <el-table-column prop="meterAddress" min-width="100" label="同比增减"></el-table-column>
        <el-table-column prop="meterAddress" min-width="120" label="同比增减率"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="抄表员"></el-table-column>
      </el-table>
      <!-- 分页 -->
      <div class="block">
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '用水排名表', method: () => { window.histroy.back() } }
        ],
  ...
  mounted() {
    ...
    this.common.changeTable(this, '.PrecedenceTable .kl-table', ['.PrecedenceTable .toolbar', '.PrecedenceTable .block', '.PrecedenceTable bread-contain'])
  },
  methods: {
    init() {
