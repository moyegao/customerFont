...
<template>
  ...
  <div class="DealingBadDebts">
    ...
    <div class="indexContent" v-if="DealingBadDebtsVisible">
      <DealingBadDebtsEdit ref="childDealingBadDebts" :tableData="histroyData"></DealingBadDebtsEdit>
    </div>
    ...
    <div class="indexContent" v-else>
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
          ...
          <el-table-column prop="areaName1" min-width="80" label="单据编号">
          </el-table-column>

          <el-table-column prop="areaName2" min-width="80" label="单据日期">
          </el-table-column>
          ...
          <el-table-column prop="lvalue" min-width="80" label="呆账金额">
          </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.common.changeTable(this, ".DealingBadDebts", [
      ".DealingBadDebts .toolbar",
      ".DealingBadDebts .block",
      ".DealingBadDebts #crumbs"
    ]);
  },
  methods: {
    init() {
