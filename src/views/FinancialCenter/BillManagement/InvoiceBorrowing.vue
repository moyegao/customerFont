...
<template>
  ...
  <div class="InvoiceBorrowing">
    ...
    <el-dialog title="调用" :visible.sync="callVisible" :close-on-click-modal="false" class="CallDialog" @close="closeDialog">
      ...
      <el-form class="formBill " :inline="true" size="mini" label-width="130px" :model="callData">
        <el-form-item label="开始号码：" class="">
          <el-input v-model="callData.con" placeholder="请输入开始号码"></el-input>
        </el-form-item>
        <el-form-item label="结束号码：" class="">
          <el-input v-model="callData.con" placeholder="请输入结束号码"></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-else>
        <el-button type="primary" size="mini">调用历史</el-button>
      </div>
    </div>
    <div v-show="InvoiceBorrowingVisible">
      <InvoiceBorrowingEdit ref="childWarehousing"></InvoiceBorrowingEdit>
    </div>
    <section v-show="InvoiceBorrowingShow">
      <div class="toolbar">
        <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
          ...
          <el-form-item class="form-left">
            ...
            <el-form-item label="调用人：">
              <el-input v-model="formData.con1" placeholder="请输入调用人"></el-input>
            </el-form-item>

            <el-form-item label="被调用人：">
              <el-input v-model="formData.con1" placeholder="请输入被调用人"></el-input>
            </el-form-item>
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
          ...
          <el-table-column prop="connect" min-width="100" label="票据类型">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="发票代码">

          </el-table-column>

          <el-table-column prop="connect" min-width="100" label="开始号码">
          </el-table-column>

          <el-table-column prop="lvalue" min-width="100" label="结束号码">
          </el-table-column>

          <el-table-column prop="lvalue" min-width="100" label="发票数量">
          </el-table-column>

          <el-table-column prop="lvalue" min-width="100" label="调用人">
          </el-table-column>

          <el-table-column prop="fixValue" min-width="80" label="被调用人">
          </el-table-column>

          <el-table-column label="操作" fixed="right" width="120">
            <template slot-scope="scope">
              <el-button type="text" @click.native="edit(scope.$index, scope.row)">调用</el-button>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    submit(formName) {
      //提交
      this.$refs.childInvoiceBorrowing.submit();
      // this.InvoiceBorrowingVisible = false;
    },
    add() {
