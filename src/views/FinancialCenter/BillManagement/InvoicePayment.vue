  ...
  <div class="InvoicePayment">
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
        ...
        <el-table-column prop="connect" min-width="100" label="交票状态">
        </el-table-column>

        <el-table-column prop="connect" min-width="100" label="发票类型">
        </el-table-column>

        <el-table-column prop="connect" min-width="100" label="发票代号">
        </el-table-column>
        ...
        <el-table-column prop="fixValue" min-width="80" label="发票数量">
        </el-table-column>

        <el-table-column prop="fixValue" min-width="80" label="已用">
        </el-table-column>

        <el-table-column prop="flux" min-width="80" label="已作废">
        </el-table-column>

        <el-table-column prop="flux" min-width="80" label="当前号码">
        </el-table-column>

        <el-table-column prop="flux" min-width="80" label="合计金额">
        </el-table-column>

        <el-table-column label="操作" fixed="right" width="80">
          <template slot-scope="scope">
            <el-button type="text" @click.native="edit(scope.$index, scope.row)">交票</el-button>
          </template>
        </el-table-column>
