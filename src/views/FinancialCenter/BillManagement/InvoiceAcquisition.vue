  ...
  <div class="InvoiceAcquisition">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-else>
        <el-button type="primary" size="mini">领用</el-button>
      </div>
    </div>
    <div v-show="InvoiceAcquisitionVisible">
      <InvoiceAcquisitionEdit ref="childWarehousing"></InvoiceAcquisitionEdit>
    </div>
    <section v-show="InvoiceAcquisitionShow">
      <div class="toolbar">
        <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
          ...
          <el-form-item class="form-left">
            ...
            <el-form-item label="所属部门：" prop="PriceStrategy">
              <el-select clearable v-model="BillManagementEditForm.PriceStrategy" placeholder="税务局">
                <el-option v-for="(item,index) in BillManagementEditForm.SourceBills" :key="index" :label="item.name" :value="item.value"></el-option>
              </el-select>
            </el-form-item>

            <el-form-item label="模糊查询：" class="width-200">
              <el-input v-model="formData.con" placeholder="发票代码/发票号码/领用人"></el-input>
            </el-form-item>
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
          ...
          <el-table-column prop="fixValue" min-width="80" label="已用数量">
          </el-table-column>

          <el-table-column prop="flux" min-width="80" label="当前号码">
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      InvoiceAcquisitionName: "发票领用-领用",
      ruleFormData: {},
