<template>
  ...
  <div class="GarbagePricing">
        <div class="bread-contain">
            ...
            <div class="bread-contain-right">
                <font v-if='indexShow==true'>
                    ...
                    <el-button type="primary" size="mini" icon="el-icon-plus"  @click="add">保存</el-button>
                </font>
                <font v-else>
    ...
    <GarbagePricingHistorical v-if='indexShow==false' ref="ManualCollectionEdit" ></GarbagePricingHistorical>
    ...
    <div v-else class='indexPage'>
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableList.list" class="change-tables-table">
            ...
            <el-table-column prop="state" min-width="80" label="用户编号">
            </el-table-column>
            ...
            <el-table-column prop="CalculationType"   min-width="100" label="计算类型">
                <template slot-scope="scope">
                <el-select 
                    v-model="scope.row.CalculationType"  
                    :change="changeCalculation(scope.row.CalculationType)">
                    <el-option label="按水量" value="0"></el-option>
                    <el-option label="按公式" value="1"></el-option>
                </el-select>
                </template>
            </el-table-column>
            
            <el-table-column v-if="CollectionRatioShow" prop="CollectionRatio"   min-width="100" label="收取比例">
                <template slot-scope="scope">             
            ...
            <el-table-column v-else prop="documentType"   min-width="100" label="计算值">
                <template slot-scope="scope">             
                <el-input v-model="scope.row.bookNum"  >
                </el-input>
                </template>
            ...
            <el-table-column prop="CalculationNum"   min-width="100" label="计算数量">
                <template slot-scope="scope">             
                <el-input v-model="scope.row.bookNum"  >
                </el-input>
                </template>
            ...
            <el-table-column prop="documentType"   min-width="100" label="计算单位">
                <template slot-scope="scope">
                <el-select 
            ...
            <el-table-column prop="documentType"   min-width="100" label="备注">
                <template slot-scope="scope">             
                <el-input v-model="scope.row.bookNum"  >
                </el-input>
                </template>
...
export default {
  ...
  mounted() {
    ...
    this.common.changeTable(this, '.GarbagePricing .kl-table', ['.GarbagePricing .toolbar', '.GarbagePricing .block', '.GarbagePricing .bread-contain'])
  },
  methods: {
