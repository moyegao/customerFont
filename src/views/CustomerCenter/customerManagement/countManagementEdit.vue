...
<template>
  <div class="countManagementEdit">
    <el-tabs type="border-card" v-model="tabsName">
      <el-tab-pane label="变更前" name="before">
        <el-form class="backfillSubmitForm" :inline="true" :model="countManagementEditForm" label-width="160px" ref="ruleForm" :rules="rules">
          <legend>客户信息</legend>
          ...
          <el-form-item label="账户类型：">
            <el-input v-model="countManagementEditForm.PriceStrategy" placeholder="" disabled class="read-only"></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="变更后" name="after">
        <el-form class="backfillSubmitForm" :inline="true" :model="countManagementEditForm" label-width="160px" ref="ruleForm" :rules="rules">
          ...
          <el-form-item :label="v.label" v-for="(v,i) in countManagementEditForm.backfillInput1" :key="i">
            <el-input v-model="v.value" :placeholder="v.tips" disabled class="read-only"></el-input>
          </el-form-item>
          <el-form-item label="座机号码：">
            <el-input v-model="countManagementEditForm.phoneNumber" placeholder="15300000000"></el-input>
          </el-form-item>
          <el-form-item label="手机号码：">
            <el-input v-model="countManagementEditForm.phoneNumber1" placeholder="15300000000"></el-input>
          </el-form-item>
          ...
          <el-form-item label="余额：">
            <el-input v-model="countManagementEditForm.isfines1" placeholder="10000" disabled class="read-only"></el-input>
          </el-form-item>
          ...
          <el-form-item label="开户名称:">
            <el-input v-model="countManagementEditForm.UpdateCodeCopye1" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="银行账户:" class='idCard'>
            <el-input v-model="countManagementEditForm.UpdateCodeCopye2" placeholder="">
