<template>
  ...
  <div class="BatchManagement">
    ...
    <BatchManagementEdit v-if='indexShow==false' ref="childWarehousing" :tableEdit="tableEdit" @chooseCtm="choosectm" @chooseAccount="chooseAccount"></BatchManagementEdit>
    ...
    <div v-else class='indexPage'>
        ...
        <el-form :inline="true" size="mini" :model="tableQuery" class="demo-form-inline">
          ...
          <el-form-item class="form-left">
            ...
            <el-form-item label="操作类型：">
              <el-select clearable v-model="tableQuery.OperationType" placeholder="">
                <el-option v-for="(item,index) in OperationTypeOptions" :key="index" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>

            <el-form-item label="模糊查询：" class="searchInput">
              <el-tooltip class="item" effect="dark" content="单据编号、用户编号、用户名称" placement="top">
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableList.list" class="change-tables-table">
            ...
            <el-table-column prop="connect1" min-width="60" label="操作类型">
            </el-table-column>

            <el-table-column prop="engineeringState" min-width="100" label="操作户数">
            </el-table-column>
...
<script>
import BatchManagementEdit from './BatchManagementEdit'
export default {
  ...
  mounted() {
    ...
    this.common.changeTable(this, '.BatchManagement .kl-table', ['.BatchManagement .toolbar', '.BatchManagement .block', '.BatchManagement .bread-contain'])
  },
  methods: {
    init() {
      let _this = this
