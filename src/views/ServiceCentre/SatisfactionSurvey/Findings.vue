...
<template>
  <div class="Findings">
    <!-- 弹出表单增加 -->
    <el-dialog :title="FindingsName" :close-on-click-modal="false" :visible.sync="FindingsVisible" class="common-dialog" @close="closeDialog">
      <FindingsEdit ref="childFindings"></FindingsEdit>
    </el-dialog>
    <div class="toolbar">
      <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
        ...
        <el-form-item class="form-left">
          ...
          <el-form-item label="答卷渠道：">
            <el-select v-model="formData.waterMeterType" placeholder="请选择">
              <el-option v-for="item in formData.waterMeterTypeOptions" :key="item.value" :label="item.name" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>

          <el-form-item label="模糊查询：" class="width-200">
            <el-input v-model="formData.con" placeholder="问卷主题/答卷人"></el-input>
          </el-form-item>
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
        ...
        <el-table-column prop="lvalue" min-width="80" label="问卷主题">

        </el-table-column>

        <el-table-column prop="lvalue" min-width="100" label="答卷人">
        </el-table-column>

        <el-table-column prop="lvalue" min-width="100" label="联系方式">
        </el-table-column>

        <el-table-column prop="fixValue" min-width="120" label="答卷分数">
        </el-table-column>

        <el-table-column prop="fixValue" min-width="120" label="答卷时间">
        </el-table-column>

        <el-table-column prop="flux" min-width="80" label="答卷渠道">
        </el-table-column>
...
<script>
import FindingsEdit from "./PreviewQuestionnaire";
export default {
  name: "Findings",
  components: {
    FindingsEdit
