...
export default {
    ...
    mounted(){
      ...
      this.common.changeTable(this,'.WechatNotification .kl-table',['.WechatNotification .toolbar','.WechatNotification .block','.WechatNotification #crumbs'])
    },
    methods: {
        init(){
